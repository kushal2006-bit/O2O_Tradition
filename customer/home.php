...
<nav class="navbar">
  ...
  <div class="nav-right">
    ...
    <a class="nav-link" href="occasion.php">Occasions</a>
    <a class="nav-link" href="orders.php">My Orders</a><a class="nav-link" href="recommendations.php">For You</a><a class="nav-link" href="assistant.php">🤖 Assistant</a>
<a class="nav-link" href="notifications.php">🔔 Alerts</a><a class="nav-link" href="rewards.php">♻ Rewards</a><a class="nav-link" href="occasions.php">🎉 Occasions</a><a class="nav-link" href="map.php">📍 Stores</a><a class="nav-link" href="assistant.php">🤖 Assistant</a>
