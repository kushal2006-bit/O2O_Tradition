...
requireText('database/migrations/034_payment_webhook_idempotency.sql', 'payment_webhook_events');
...
requireText('database/migrate.php', 'information_schema.tables');
requireText('database/migrate.php', 'Invalid migration filename');
requireText('database/migrate.php', 'Duplicate migration number');
requireText('customer/payment_callback.php', 'Payment verification could not be completed.');
requireText('customer/payment_callback.php', 'Rental order payment state could not be finalized.');
requireText('customer/payment_callback.php', 'Purchase order payment state could not be finalized.');
...
requireText('vendor/logout.php', "'samesite'=>'Lax'");
requireText('admin/logout.php', "'samesite'=>'Lax'");
